...
//...................................Budget Monthly Bibaran

const fetchbudgetmonthlybibaranRequest = (state, action) =>
  state.merge({ ...state, status: 'pending' })
const fetchbudgetmonthlybibaranSuccess = (state, action) => {
  return state.merge({
    ...state,
    status: 'done',
    budget_monthly: action.response,
  })
}
const fetchbudgetmonthlybibaranFailure = (state, action) => {
  state.merge({ ...state, status: 'error' })
}
...
export const reducer = createReducer(initialState, {
  ...
  [ReportTypes.FETCHSAMUHABHITRABANPAIDAWARBIKRIBIBARAN_REQUEST]:
    fetchsamuhabhitrabanpaidawarbikribibaranRequest,
  [ReportTypes.FETCHSAMUHABHITRABANPAIDAWARBIKRIBIBARAN_SUCCESS]:
    fetchsamuhabhitrabanpaidawarbikribibaranSuccess,
  [ReportTypes.FETCHSAMUHABHITRABANPAIDAWARBIKRIBIBARAN_FAILURE]:
    fetchsamuhabhitrabanpaidawarbikribibaranFailure,

  [ReportTypes.FETCHBANXETRAATIKRAMANNIYANTRAN_REQUEST]:
    fetchbanxetraatikramanniyantranRequest,
  [ReportTypes.FETCHBANXETRAATIKRAMANNIYANTRAN_SUCCESS]:
    fetchbanxetraatikramanniyantranSuccess,
  [ReportTypes.FETCHBANXETRAATIKRAMANNIYANTRAN_FAILURE]:
    fetchbanxetraatikramanniyantranFailure,

  [ReportTypes.FETCHBANYAJANTUXETIRAHAT_REQUEST]:
    fetchbanyajantuxetirahatRequest,
  [ReportTypes.FETCHBANYAJANTUXETIRAHAT_SUCCESS]:
    fetchbanyajantuxetirahatSuccess,
  [ReportTypes.FETCHBANYAJANTUXETIRAHAT_FAILURE]:
    fetchbanyajantuxetirahatFailure,

  [ReportTypes.FETCHBANYAJANTUUDDARBIBARAN_REQUEST]:
    fetchbanyajantuuddarbibaranRequest,
  [ReportTypes.FETCHBANYAJANTUUDDARBIBARAN_SUCCESS]:
    fetchbanyajantuuddarbibaranSuccess,
  [ReportTypes.FETCHBANYAJANTUUDDARBIBARAN_FAILURE]:
    fetchbanyajantuuddarbibaranFailure,

  [ReportTypes.FETCHBANDADELOXETIBIBARAN_REQUEST]:
    fetchbandadeloxetibibaranRequest,
  [ReportTypes.FETCHBANDADELOXETIBIBARAN_SUCCESS]:
    fetchbandadeloxetibibaranSuccess,
  [ReportTypes.FETCHBANDADELOXETIBIBARAN_FAILURE]:
    fetchbandadeloxetibibaranFailure,

  [ReportTypes.FETCHBANXETRAANYAPRAYOJANBIBARAN_REQUEST]:
    fetchbanxetraanyaprayojanbibaranRequest,
  [ReportTypes.FETCHBANXETRAANYAPRAYOJANBIBARAN_SUCCESS]:
    fetchbanxetraanyaprayojanbibaranSuccess,
  [ReportTypes.FETCHBANXETRAANYAPRAYOJANBIBARAN_FAILURE]:
    fetchbanxetraanyaprayojanbibaranFailure,

  [ReportTypes.FETCHMUDDAANUSANDHANDAYARIBIBARAN_REQUEST]:
    fetchmuddaanusandhandayaribibaranRequest,
  [ReportTypes.FETCHMUDDAANUSANDHANDAYARIBIBARAN_SUCCESS]:
    fetchmuddaanusandhandayaribibaranSuccess,
  [ReportTypes.FETCHMUDDAANUSANDHANDAYARIBIBARAN_FAILURE]:
    fetchmuddaanusandhandayaribibaranFailure,

  [ReportTypes.FETCHGAIRAKASTHABANPAIDAWARBIKRIBITARAN_REQUEST]:
    fetchgairakasthabanpaidawarbikribitaranRequest,
  [ReportTypes.FETCHGAIRAKASTHABANPAIDAWARBIKRIBITARAN_SUCCESS]:
    fetchgairakasthabanpaidawarbikribitaranSuccess,
  [ReportTypes.FETCHGAIRAKASTHABANPAIDAWARBIKRIBITARAN_FAILURE]:
    fetchgairakasthabanpaidawarbikribitaranFailure,

  [ReportTypes.FETCHKATHDAURABIKRIBITARAN_REQUEST]:
    fetchkathdaurabikribitaranRequest,
  [ReportTypes.FETCHKATHDAURABIKRIBITARAN_SUCCESS]:
    fetchkathdaurabikribitaranSuccess,
  [ReportTypes.FETCHKATHDAURABIKRIBITARAN_FAILURE]:
    fetchkathdaurabikribitaranFailure,

  [ReportTypes.FETCHBIRUWAUTPADANKHARID_REQUEST]:
    fetchbiruwautpadankharidRequest,
  [ReportTypes.FETCHBIRUWAUTPADANKHARID_SUCCESS]:
    fetchbiruwautpadankharidSuccess,
  [ReportTypes.FETCHBIRUWAUTPADANKHARID_FAILURE]:
    fetchbiruwautpadankharidFailure,
  ...
  [ReportTypes.FETCHSRIJANABHAYEKOROJGARI_REQUEST]:
    fetchsrijanabhayekorojgariRequest,
  [ReportTypes.FETCHSRIJANABHAYEKOROJGARI_SUCCESS]:
    fetchsrijanabhayekorojgariSuccess,
  [ReportTypes.FETCHSRIJANABHAYEKOROJGARI_FAILURE]:
    fetchsrijanabhayekorojgariFailure,
  ...
  [ReportTypes.FETCHBANHASTANTARANBIBARAN_SUCCESS]:
    fetchbanhastantaranbibaranSuccess,
  [ReportTypes.FETCHBANHASTANTARANBIBARAN_FAILURE]:
    fetchbanhastantaranbibaranFailure,

  //.............. Budget Monthly Bibaran
  [ReportTypes.FETCHBUDGETMONTHLYBIBARAN_REQUEST]:
    fetchbudgetmonthlybibaranRequest,
  [ReportTypes.FETCHBUDGETMONTHLYBIBARAN_SUCCESS]:
    fetchbudgetmonthlybibaranSuccess,
  [ReportTypes.FETCHBUDGETMONTHLYBIBARAN_FAILURE]:
    fetchbudgetmonthlybibaranFailure,
