...
class Edit extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      emp_add_perm_prov: englishToNepaliNumber(
        props.history.location.item?.emp_add_perm_prov
      ),
      emp_add_perm_dist: englishToNepaliNumber(
        props.history.location.item?.emp_add_perm_dist
      ),
      emp_add_perm_mun: englishToNepaliNumber(
        props.history.location.item?.emp_add_perm_mun
      ),
      emp_add_perm_ward: englishToNepaliNumber(
        props.history.location.item?.emp_add_perm_ward
      ),
      emp_add_perm_tole: englishToNepaliNumber(
        props.history.location.item?.emp_add_temp_tole
      ),
      emp_add_temp_prov: englishToNepaliNumber(
        props.history.location.item?.emp_add_perm_prov
      ),
      emp_add_temp_dist: englishToNepaliNumber(
        props.history.location.item?.emp_add_perm_dist
      ),
      emp_add_temp_mun: englishToNepaliNumber(
        props.history.location.item?.emp_add_perm_mun
      ),
      emp_add_temp_ward: englishToNepaliNumber(
        props.history.location.item?.emp_add_perm_ward
      ),
      emp_add_temp_tole: englishToNepaliNumber(
        props.history.location.item?.emp_add_perm_tole
      ),
      ...
      emp_office_id: englishToNepaliNumber(
        props.history.location.item?.emp_office_id
      ),
      emp_dept_id: englishToNepaliNumber(
        props.history.location.item?.emp_dept_id
      ),
      emp_level_id: englishToNepaliNumber(
        props.history.location.item?.emp_level_id
      ),
      emp_post: props.history.location.item?.emp_post,
      emp_rank: englishToNepaliNumber(props.history.location.item?.emp_rank),
      emp_appoint_date: englishToNepaliNumber(
        props.history.location.item?.emp_appoint_date
      ),
