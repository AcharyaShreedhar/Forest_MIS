...
class Edit extends Component {
  constructor(props) {
    super(props);
    this.state = {
      id: props.history.location.item.panimuhansamrakshyan_id,
  ...
  handleSubmit() {
    const {id, sthan, qty, karyakram_miti, laagat, created_by } =
      this.state;
    const payload = {
      ...
      <React.Fragment>
        <div className=" card p-5 border-5">
          <ConfirmationDialoge
            ...
            title="थप"
            body="के तपाईँ पानीमुहान संरक्षण सम्बन्धी विवरण शंसोधन  गर्न चाहनुहुन्छ ?"
