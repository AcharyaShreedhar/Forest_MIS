...
import {
  ...
  fetchallbadhibibaranRequest,
  fetchbadhibibaranRequest,
...
import {
  ...
  addsamrakshyanpokharinirmanRequest,
  ...
  deletejaladharsamrakshyanRequest,
  fetchallnadikinarsamrakshyanRequest,
  fetchnadikinarsamrakshyanRequest,
  ...
  fetchpanimuhansamrakshyanRequest,
...
export default function* root() {
  yield all([
    ...
    takeLatest(
      BipatbibaranTypes.FETCHALLBADHIBIBARAN_REQUEST,
      fetchallbadhibibaranRequest,
      api
    ),
    takeLatest(
      BipatbibaranTypes.FETCHBADHIBIBARAN_REQUEST,
      fetchbadhibibaranRequest,
      api
    ),
    takeLatest(
      BipatbibaranTypes.ADDBADHIBIBARAN_REQUEST,
      addbadhibibaranRequest,
      api
    ),
    takeLatest(
      BipatbibaranTypes.UPDATEBADHIBIBARAN_REQUEST,
      updatebadhibibaranRequest,
      api
    ),
    takeLatest(
    ...
    takeLatest(
      SamrakshyanTypes.ADDSAMRAKSHYANPOKHARINIRMAN_REQUEST,
      addsamrakshyanpokharinirmanRequest,
      api
    ),
    takeLatest(
      SamrakshyanTypes.UPDATESAMRAKSHYANPOKHARINIRMAN_REQUEST,
      updatesamrakshyanpokharinirmanRequest,
      api
    ),
    takeLatest(
      SamrakshyanTypes.DELETESAMRAKSHYANPOKHARINIRMAN_REQUEST,
      deletesamrakshyanpokharinirmanRequest,
      api
    ),
    takeLatest(
      SamrakshyanTypes.FETCHALLJALADHARSAMRAKSHYAN_REQUEST,
      fetchalljaladharsamrakshyanRequest,
      api
    ),
    takeLatest(
      SamrakshyanTypes.FETCHJALADHARSAMRAKSHYAN_REQUEST,
      fetchjaladharsamrakshyanRequest,
      api
    ),
    takeLatest(
    ...
    takeLatest(
      SamrakshyanTypes.DELETEJALADHARSAMRAKSHYAN_REQUEST,
      deletejaladharsamrakshyanRequest,
      api
    ),
    takeLatest(
      SamrakshyanTypes.FETCHALLNADIKINARSAMRAKSHYAN_REQUEST,
      fetchallnadikinarsamrakshyanRequest,
      api
    ),
    takeLatest(
      SamrakshyanTypes.FETCHNADIKINARSAMRAKSHYAN_REQUEST,
      fetchnadikinarsamrakshyanRequest,
      api
    ),
    takeLatest(
      SamrakshyanTypes.ADDNADIKINARSAMRAKSHYAN_REQUEST,
      addnadikinarsamrakshyanRequest,
      api
    ),
    takeLatest(
    ...
    takeLatest(
      SamrakshyanTypes.FETCHPANIMUHANSAMRAKSHYAN_REQUEST,
      fetchpanimuhansamrakshyanRequest,
      api
    ),
    takeLatest(
      SamrakshyanTypes.ADDPANIMUHANSAMRAKSHYAN_REQUEST,
      addpanimuhansamrakshyanRequest,
      api
    ),
    takeLatest(
      SamrakshyanTypes.UPDATEPANIMUHANSAMRAKSHYAN_REQUEST,
      updatepanimuhansamrakshyanRequest,
      api
    ),
    takeLatest(
      SamrakshyanTypes.DELETEPANIMUHANSAMRAKSHYAN_REQUEST,
      deletepanimuhansamrakshyanRequest,
      api
    ),
    ...
    takeLatest(
      ReportTypes.FETCHUDDHAMBIBARAN_REQUEST,
      fetchuddhambibaranRequest,
      api
    ),
    takeLatest(
    ...
    takeLatest(
      ReportTypes.FETCHUPAVOKTASUSASAN_REQUEST,
      fetchupavoktasusasanRequest,
      api
    ),
    takeLatest(
