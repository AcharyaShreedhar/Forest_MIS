...
import { KarmachariBibaran, Filter, ReportGenerator } from "../../../components";
import KarmacharibibaranActions from "../../../actions/karmacharibibaran";
import { karmacharibibaranHeadings } from "../../../services/config";
import { Fragment } from "react";

class Karmacharibibaran extends Component {
  constructor(props) {
      super(props);
      this.state = { loc: "karmacharibibaranlist",perPage: 10, page: 0  };
          ...
          <div>
            ...
            <div className="report-filter">
              ...
              <KarmachariBibaran.List
               ...
               data={!isNil(karmacharibibaranList) ? karmacharibibaranList.list : []}
               per={perPage}
               pers={[10, 25, 50, "all"]}
               ...
               onPageClick={(e) => this.handlePageChange(e, "karmacharibibaran")}
              />
             </Fragment> 
            )}
