...
async function getBanxetraAnyaprayojanBibaran(req, res) {
  const getBanxetraAnyaprayojanBibaranQuery =
    "SELECT sanstha_name,xetrafal_temp as asthai_prayojan_area,xetrafal_perm as sthai_prayojan_area,upalabdha_address as jaggako_sthan, prayojan FROM `banxetra_anyaprayojans` WHERE dist_id LIKE ?";
