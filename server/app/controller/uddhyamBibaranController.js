...
async function addUddhyamBibaran(req, res) {
  const addUddhyamBibaranQuery = `INSERT INTO uddhyam_bibarans(dist_id,niji_uddhyam_sankhya,niji_rojgari_sankhya,samudayik_uddhyam_sankhya,samudayik_rojgari_sankhya,sahakari_uddhyam_sankhya,sahakari_rojgari_sankhya,created_by,updated_by) values (?,?,?,?,?,?,?,?,?)`;
  pool.query(
...
async function updateUddhyamBibaran(req, res) {
  const updateUddhyamBibaranQuery = `UPDATE uddhyam_bibarans SET dist_id=?, niji_uddhyam_sankhya=?,niji_rojgari_sankhya=?,samudayik_uddhyam_sankhya=?,samudayik_rojgari_sankhya=?,sahakari_uddhyam_sankhya=?,sahakari_rojgari_sankhya=?,created_by=?,updated_by=? WHERE uddhyam_id=?`;
  pool.query(
