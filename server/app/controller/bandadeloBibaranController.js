...
async function getBandadeloBibaran(req, res) {
  ...
  async function addBandadeloBibaran(req, res) {
    const addBandadeloBibaranQuery = `INSERT INTO bandadelo_bibarans (bandadelo_address, ban_type, ban_prajati, xeti_area, niyantran_prayas, niyantran_karta, sahabhagi_mahila, sahabhagi_purus, bandadelo_miti, created_by, updated_by) values (?,?,?,?,?,?,?,?,?,?,?)`;
    pool.query(
  ...
  async function updateBandadeloBibaran(req, res) {
    const updateBandadeloBibaranQuery = `UPDATE bandadelo_bibarans SET bandadelo_address=?, ban_type=?, ban_prajati=?, xeti_area=?, niyantran_prayas=?, niyantran_karta=?, sahabhagi_mahila=?, sahabhagi_purus=?, bandadelo_miti=?, created_by=?, updated_by=? WHERE bandadelo_bibaran_id=?`;
    pool.query(
