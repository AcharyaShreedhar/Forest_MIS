...
module.exports = {
  addMuddaAnusandhanDayari: (callBack) => {
    const addMuddaAnusandhanDayariQuery = `INSERT INTO mudda_anusandhan_dayari (jaheri_partibedan_miti, kasurko_kisim, bigo_pariman, jaggako_area, jaggako_thegana, abhiyog_miti, abhiyog_nikaya, abhiyog_jariwana, kaid, bojbahak_jafat_maagdabi, pratibadi_sankhya, thunchek_dharauti, sadharan_tarekh, thuna_aadhes, faisala_miti, faisala_jariwana, faisala_kaid, bojbahak_jafat, created_by, updated_by) values ($1,$2,$3,$4,$5,$^,$7,$8,$9) returning *`;
    pool.query(
