...
module.exports = {
  updateActivitiesInfo: (callBack) => {
    const updateActivitiesInfoQuery = `UPDATE activities_info SET fiscal_year=$1, community_forest_name=$2, area=$3, production_from_conservation_timber=$4, production_from_conservation_wood=$5, employment_generated_workingday=$6, distribution_withingroup_timber=$7, distribution_withingroup_wood=$8, distribution_outsidegroup_timber=$9, distribution_outsidegroup_timber=$10, distribution_outsidegroup_wood=$11, distribution_maujdat_timber=$12, distribution_maujdat_wood=$13, amdani_kharcha_bibaran_annual_income=$14, amdani_kharcha_bibaran_annual_expenditure=$15, amdani_kharcha_bibaran_nett_annual_saving=$16, niyamit_rojgar_count=$17, community_udhyam_bibaran=$18, annual_bibaran_bujhayeko_nabujhayeko=$19, lekha_parikshyan_garaiyeko_nagariyeko=$20,created_by=$21, updated_by=$22 WHERE activitiesInfo_id=$23 returning *`;
    pool.query(
...
module.exports = {
  deleteActivitiesInfo: (callBack) => {
    const deleteActivitiesInfoQuery = `DELETE  FROM activities_info where activities_info_id=$1`;
    pool.query(
