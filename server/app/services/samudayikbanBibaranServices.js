...
module.exports = {
  updateSamudayikbanBibaran: (callBack) => {
    const updateSamudayikbanBibaranQuery = `UPDATE  SET samudayikban_name=$1, area=$2, main_species=$3, forest_type=$4, handover_date=$5, renewal_first_date=$6, renewal_first_period=$7, renewal_second_date=$8, renewal_second_period=$9, renewal_third_date=$10, renewal_third_period=$11, renewal_fourth_date=$12, renewal_fourth_period=$13, renewal_fifth_date=$14, renewal_fifth_period=$15, renewal_sixth_date=$16, renewal_sixth_period=$17, forest_maujdat=$18, annual_nikasi_amount_timber=$19, annual_nikasi_wood=$19,renewal_fy=$20, created_by=$21, updated_by=$22 WHERE samudayikban_bibaran_id=$23 returning *`;
    pool.query(
